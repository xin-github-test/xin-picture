...
/** listPictureVOByPageWithCaffeCache POST /api/picture/list/page/vo/caffe */
export async function listPictureVoByPageWithCaffeCacheUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePictureVO_>('/api/picture/list/page/vo/caffe', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** createPictureOutPaintingTask POST /api/picture/out_painting/creat_task */
export async function createPictureOutPaintingTaskUsingPost(
  ...
  return request<API.BaseResponseCreateOutPaintingTaskResponse_>(
    '/api/picture/out_painting/creat_task',
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
